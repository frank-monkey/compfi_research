...
def path_independent_pricing(prices, option_pricing, K, p, n, r, t=0):
    q=1-p
...
print(path_dependent_pricing(bachelier_model(10, 10, 1, 2), pricing_methods.arithmetic_asian_call, 10, 10, 0.25, 1) )
