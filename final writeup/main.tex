...
%this into the chooser option from 1.7
\begin{align}
...
FIXME/To be added
-Note from BM Appendix that the mean of the brownian motions in both $Y$ and $Z$ are $0$, thus the means of both $Y$ and $Z$ are 0. 
\begin{align}
     Var(Y) &= \tau \left(\frac{\kappa(T-\tau)}{T} \right)^2\\
     Var(Z) &= \frac{\tau^3}{3} \left(\frac{\kappa}{T}\right)^2
\end{align}
