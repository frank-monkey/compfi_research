...
To compute the price of a put, one can use put-call parity \eqref{Put-Call Parity}.
...
The RHS can be replicated by investing $Ke^{r(\tau - T)}$ and shorting an option at $w_\tau$ which pays $A_T$ at time $T$, all at time time $\tau$.
Thus, 
\begin{align} \label{Put-Call Parity}
