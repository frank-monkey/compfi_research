...
\end{align}
where $S_0 > 0$ denotes the initial stock price at time 0 and $\{W_t\}_{t \ge 0}$ is a Brownian motion under the risk neutral measure $\tilde{\mathbb{P}}$.
(FIXME: Define $\kappa$)
...
To compute the price of a put, one can use put-call parity (FIXME: derive put-call parity in appendix and reference it). 
